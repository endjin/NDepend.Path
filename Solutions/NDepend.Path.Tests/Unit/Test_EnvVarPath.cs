...
namespace NDepend.Path
{
    ...
    public class Test_EnvVarPath
    {
        ...
        public void TestSyntaxEnvVar_KO(string path)
        {
            ...
            Assert.Throws(typeof(ArgumentException), delegate { var dirPath = path.ToEnvVarDirectoryPath(); });
        }
        ...
        {
            Assert.IsFalse(path.IsValidEnvVarDirectoryPath());
            Assert.Throws(typeof(ArgumentNullException), delegate { var dirPath = path.ToEnvVarDirectoryPath(); });
        }
        ...
        {
            Assert.IsFalse(path.IsValidEnvVarFilePath());
            Assert.Throws(typeof(ArgumentNullException), delegate { var dirPath = path.ToEnvVarFilePath(); });
        }
        ...
        public void TestSyntaxEnvVar_DirOK_FileKO(string path)
        {
            Assert.IsTrue(path.IsValidEnvVarDirectoryPath());
            Assert.IsFalse(path.IsValidEnvVarFilePath());
            Assert.Throws(typeof(ArgumentException), delegate { var dirPath = path.ToEnvVarFilePath(); });
        }
