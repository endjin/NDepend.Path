...
namespace NDepend.Path
{
    ...
    public class Test_DirectoryPath
    {
        ...
        public void Test_InvalidInputAbsolutePath1()
        {
            ...
            Assert.Throws(typeof(ArgumentException), delegate { IDirectoryPath directoryPath = "C".ToAbsoluteDirectoryPath(); });
        }
        ...
        public void Test_InvalidInputAbsolutePath1_()
        {
            ...
            Assert.Throws(typeof(ArgumentException), delegate { IDirectoryPath directoryPath = "C:a".ToAbsoluteDirectoryPath(); });
        }
        ...
        public void Test_InvalidInputAbsolutePath2()
        {
            ...
            Assert.Throws(typeof(ArgumentException), delegate { IDirectoryPath directoryPath = @"C\Dir1".ToAbsoluteDirectoryPath(); });
        }
        ...
        public void Test_InvalidInputAbsolutePath3()
        {
            ...
            Assert.Throws(typeof(ArgumentException), delegate { IDirectoryPath directoryPath = @"1:\Dir1".ToAbsoluteDirectoryPath(); });
        }
        ...
        public void Test_InvalidInputAbsoluteURNPath()
        {
            ...
            Assert.Throws(typeof(ArgumentException), delegate { IDirectoryPath directoryPath = "http://www.NDepend.com".ToAbsoluteDirectoryPath(); });
        }
        ...
        {
            Assert.IsFalse(@"C:\..".IsValidAbsoluteDirectoryPath());
            Assert.Throws(typeof(ArgumentException), delegate { IFilePath filePath = @"C:\..".ToAbsoluteFilePath(); });
        }
        ...
        {
            Assert.IsFalse(@"C:\..\Dir1\".IsValidAbsoluteDirectoryPath());
            Assert.Throws(typeof(ArgumentException), delegate { IFilePath filePath = @"C:\..\Dir1\".ToAbsoluteFilePath(); });
        }
   ...
   PathTo   = ""..\..\Dir1""");
        ...
        {
            Assert.IsTrue(@"C:\Dir1\Dir2".ToAbsoluteDirectoryPath().GetBrotherDirectoryWithName("Dir3").Equals(@"C:\Dir1\Dir3".ToAbsoluteDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName2()
        {
            Assert.IsTrue(@"C:\Dir1\Dir2".ToDirectoryPath().GetBrotherDirectoryWithName("Dir3").Equals(@"C:\Dir1\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName3()
        {
            Assert.IsTrue((@"C:\Dir1\Dir2".ToAbsoluteDirectoryPath() as IDirectoryPath).GetBrotherDirectoryWithName("Dir3").Equals(@"C:\Dir1\Dir3".ToAbsoluteDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName4()
        {
            Assert.IsTrue((@"C:\Dir1\Dir2".ToDirectoryPath() as IDirectoryPath).GetBrotherDirectoryWithName("Dir3").Equals(@"C:\Dir1\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName5()
        {
            Assert.IsTrue(@"..\Dir1\Dir2".ToRelativeDirectoryPath().GetBrotherDirectoryWithName("Dir3").Equals(@"..\Dir1\Dir3".ToRelativeDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName6()
        {
            Assert.IsTrue(@"..\Dir1\Dir2".ToDirectoryPath().GetBrotherDirectoryWithName("Dir3").Equals(@"..\Dir1\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName7()
        {
            Assert.IsTrue(@"C:\Dir1\Dir2".ToAbsoluteDirectoryPath().GetBrotherFileWithName("File.txt").Equals(@"C:\Dir1\File.txt".ToAbsoluteFilePath()));
        }

        [Test]
        public void Test_GetBrotherWithName8()
        {
            Assert.IsTrue(@"C:\Dir1\Dir2".ToDirectoryPath().GetBrotherFileWithName("File.txt").Equals(@"C:\Dir1\File.txt".ToFilePath()));
        }

        [Test]
        public void Test_GetBrotherWithName9()
        {
            Assert.IsTrue(@"..\Dir1\Dir2".ToRelativeDirectoryPath().GetBrotherFileWithName("File.txt").Equals(@"..\Dir1\File.txt".ToRelativeFilePath()));
        }
        [Test]
        public void Test_GetBrotherWithName10()
        {
            Assert.IsTrue(@"..\Dir1\Dir2".ToDirectoryPath().GetBrotherFileWithName("File.txt").Equals(@"..\Dir1\File.txt".ToFilePath()));
        }

        [Test]
        public void Test_GetBrotherWithName11()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2".ToEnvVarDirectoryPath().GetBrotherDirectoryWithName("Dir3").Equals(@"%E%\Dir1\Dir3".ToEnvVarDirectoryPath()));
        }
        [Test]
        public void Test_GetBrotherWithName12()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2".ToDirectoryPath().GetBrotherDirectoryWithName("Dir3").Equals(@"%E%\Dir1\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName13()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2".ToEnvVarDirectoryPath().GetBrotherFileWithName("File.txt").Equals(@"%E%\Dir1\File.txt".ToEnvVarFilePath()));
        }
        [Test]
        public void Test_GetBrotherWithName14()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2".ToDirectoryPath().GetBrotherFileWithName("File.txt").Equals(@"%E%\Dir1\File.txt".ToFilePath()));
        }

        [Test]
        public void Test_GetBrotherWithName15()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2".ToEnvVarDirectoryPath().GetChildDirectoryWithName("Dir3").Equals(@"%E%\Dir1\Dir2\Dir3".ToEnvVarDirectoryPath()));
        }
        [Test]
        public void Test_GetBrotherWithName16()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2".ToDirectoryPath().GetChildDirectoryWithName("Dir3").Equals(@"%E%\Dir1\Dir2\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName17()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2".ToEnvVarDirectoryPath().GetChildFileWithName("File.txt").Equals(@"%E%\Dir1\Dir2\File.txt".ToEnvVarFilePath()));
        }
        [Test]
        ...
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2\File.txt".ToEnvVarFilePath().GetBrotherDirectoryWithName("Dir3").Equals(@"%E%\Dir1\Dir2\Dir3".ToEnvVarDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName20()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2\File.txt".ToFilePath().GetBrotherDirectoryWithName("Dir3").Equals(@"%E%\Dir1\Dir2\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName21()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2\File.txt".ToEnvVarFilePath().GetBrotherFileWithName("FILE2").Equals(@"%E%\Dir1\Dir2\FILE2".ToEnvVarFilePath()));
        }

        [Test]
        public void Test_GetBrotherWithName22()
        {
            Assert.IsTrue(@"%E%\Dir1\Dir2\File.txt".ToFilePath().GetBrotherFileWithName("FILE2").Equals(@"%E%\Dir1\Dir2\FILE2".ToFilePath()));
        }
