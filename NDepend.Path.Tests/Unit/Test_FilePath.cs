...
namespace NDepend.Path
{
    ...
    public class Test_FilePath
    {
        ...
        {
            Assert.Throws(typeof(ArgumentException), delegate { var path = @"C:\..".ToAbsoluteDirectoryPath(); });
        }

        [Test]
        public void Test_InnerSpecialDir_Error21()
        {
            Assert.Throws(typeof(ArgumentException), delegate { var path = @"C:\Dir1\..\..".ToAbsoluteDirectoryPath(); });
        }
   ...
   PathTo   = ""C:\Dir1\File.txt""");
            ...
            Assert.Throws(typeof(ArgumentException), delegate { filePathTo.GetRelativePathFrom(absoluteDirectoryPathFrom); });
        }
   ...
   PathTo   = ""..\..\Dir1""");
            ...
            Assert.Throws(typeof(ArgumentException), delegate { directoryPathTo.GetAbsolutePathFrom(absoluteDirectoryPathFrom); });
        }
        ...
        {
            Assert.IsTrue(@"C:\Dir1\File.txt".ToAbsoluteFilePath().GetBrotherDirectoryWithName("Dir3").Equals(@"C:\Dir1\Dir3".ToAbsoluteDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName2()
        {
            Assert.IsTrue(@"C:\Dir1\File.txt".ToFilePath().GetBrotherDirectoryWithName("Dir3").Equals(@"C:\Dir1\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName3()
        {
            Assert.IsTrue(@"\\server\share\Dir1\File.txt".ToAbsoluteFilePath().GetBrotherDirectoryWithName("Dir3").Equals(@"\\server\share\Dir1\Dir3".ToAbsoluteDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName4()
        {
            Assert.IsTrue(@"\\server\share\Dir1\File.txt".ToFilePath().GetBrotherDirectoryWithName("Dir3").Equals(@"\\server\share\Dir1\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName5()
        {
            Assert.IsTrue(@"..\Dir1\File.txt".ToRelativeFilePath().GetBrotherDirectoryWithName("Dir3").Equals(@"..\Dir1\Dir3".ToRelativeDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName6()
        {
            Assert.IsTrue(@"..\Dir1\File.txt".ToFilePath().GetBrotherDirectoryWithName("Dir3").Equals(@"..\Dir1\Dir3".ToDirectoryPath()));
        }

        [Test]
        public void Test_GetBrotherWithName7()
        {
            Assert.IsTrue(@"C:\Dir1\File.txt".ToAbsoluteFilePath().GetBrotherFileWithName("File.exe").Equals(@"C:\Dir1\File.exe".ToAbsoluteFilePath()));
        }

        [Test]
        public void Test_GetBrotherWithName8()
        {
            Assert.IsTrue(@"C:\Dir1\File.txt".ToFilePath().GetBrotherFileWithName("File.exe").Equals(@"C:\Dir1\File.exe".ToFilePath()));
        }

        [Test]
        public void Test_GetBrotherWithName9()
        {
            Assert.IsTrue(@"..\Dir1\File.txt".ToRelativeFilePath().GetBrotherFileWithName("File.exe").Equals(@"..\Dir1\File.exe".ToRelativeFilePath()));
        }

        [Test]
        public void Test_GetBrotherWithName10()
        {
            Assert.IsTrue(@"..\Dir1\File.txt".ToFilePath().GetBrotherFileWithName("File.exe").Equals(@"..\Dir1\File.exe".ToFilePath()));
        }
        ...
        {
            Assert.IsTrue(@"..\Dir1\File.txt".ToFilePath().UpdateExtension(".exe").Equals(@"..\Dir1\File.exe".ToFilePath()));
        }

        [Test]
        public void Test_UpdateExtension3()
        {
            Assert.IsTrue(@"..\Dir1\File".ToRelativeFilePath().UpdateExtension(".exe").Equals(@"..\Dir1\File.exe".ToRelativeFilePath()));
        }

        [Test]
        public void Test_UpdateExtension4()
        {
            Assert.IsTrue(@"..\Dir1\File".ToFilePath().UpdateExtension(".exe").Equals(@"..\Dir1\File.exe".ToFilePath()));
        }

        [Test]
        public void Test_UpdateExtension5()
        {
            Assert.IsTrue(@"..\Dir1\File.txt.bmp".ToRelativeFilePath().UpdateExtension(".exe").Equals(@"..\Dir1\File.txt.exe".ToRelativeFilePath()));
        }

        [Test]
        public void Test_UpdateExtension6()
        {
            Assert.IsTrue(@"..\Dir1\File.txt.bmp".ToFilePath().UpdateExtension(".exe").Equals(@"..\Dir1\File.txt.exe".ToFilePath()));
        }
        ...
        {
            Assert.IsTrue(@"C:\Dir1\File.txt".ToAbsoluteFilePath().UpdateExtension(".exe").Equals(@"C:\Dir1\File.exe".ToAbsoluteFilePath()));
        }

        [Test]
        public void Test_UpdateExtension10()
        {
            Assert.IsTrue(@"C:\Dir1\File.txt".ToFilePath().UpdateExtension(".exe").Equals(@"C:\Dir1\File.exe".ToFilePath()));
        }

        [Test]
        public void Test_UpdateExtension11()
        {
            Assert.IsTrue(@"\\server\share\Dir1\File.txt".ToAbsoluteFilePath().UpdateExtension(".exe").Equals(@"\\server\share\Dir1\File.exe".ToAbsoluteFilePath()));
        }

        [Test]
        public void Test_UpdateExtension12()
        {
            Assert.IsTrue(@"\\server\share\Dir1\File.txt".ToFilePath().UpdateExtension(".exe").Equals(@"\\server\share\Dir1\File.exe".ToFilePath()));
        }

        [Test]
        public void Test_UpdateExtension13()
        {
            Assert.IsTrue(@"C:\Dir1\File".ToAbsoluteFilePath().UpdateExtension(".exe").Equals(@"C:\Dir1\File.exe".ToAbsoluteFilePath()));
        }
        [Test]
        public void Test_UpdateExtension14()
        {
            Assert.IsTrue(@"C:\Dir1\File".ToFilePath().UpdateExtension(".exe").Equals(@"C:\Dir1\File.exe".ToFilePath()));
        }

        [Test]
        public void Test_UpdateExtension15()
        {
            Assert.IsTrue(@"C:\Dir1\File.txt.bmp".ToAbsoluteFilePath().UpdateExtension(".exe").Equals(@"C:\Dir1\File.txt.exe".ToAbsoluteFilePath()));
        }

        [Test]
        public void Test_UpdateExtension16()
        {
            Assert.IsTrue(@"C:\Dir1\File.txt.bmp".ToFilePath().UpdateExtension(".exe").Equals(@"C:\Dir1\File.txt.exe".ToFilePath()));
        }
        ...
        {
            Assert.IsTrue(@"%E%\Dir1\File".ToEnvVarFilePath().UpdateExtension(".exe").Equals(@"%E%\Dir1\File.exe".ToEnvVarFilePath()));
        }
        [Test]
        public void Test_UpdateExtension20()
        {
            Assert.IsTrue(@"%E%\Dir1\File".ToFilePath().UpdateExtension(".exe").Equals(@"%E%\Dir1\File.exe".ToFilePath()));
        }
